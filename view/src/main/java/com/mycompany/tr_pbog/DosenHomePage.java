...
private void setButtonIcon(javax.swing.JButton button, String path, int width, int height) {
    ...
    public DosenHomePage() {
        ...
        setButtonIcon(logoutBtn, "/image/te.png", 24, 24);
        initDateTime();
    }
...
private void initDateTime() {
    ...
    private void initComponents() {
        ...
        dashboardBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/dashboard.png"))); // NOI18N
        ...
        classBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/teaching.png"))); // NOI18N
